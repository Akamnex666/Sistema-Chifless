...
const clientes: Partial<Cliente>[] = [
  { nombre: 'María', apellido: 'González Pérez', dni: '0912345678', telefono: '0991234567', email: 'maria.gonzalez@email.com' },
  { nombre: 'Carlos', apellido: 'Rodríguez López', dni: '0923456789', telefono: '0992345678', email: 'carlos.rodriguez@email.com' },
  { nombre: 'Ana', apellido: 'Martínez Silva', dni: '0934567890', telefono: '0993456789', email: 'ana.martinez@email.com' },
  { nombre: 'José', apellido: 'Fernández Castro', dni: '0945678901', telefono: '0994567890', email: 'jose.fernandez@email.com' },
  { nombre: 'Laura', apellido: 'Sánchez Mora', dni: '0956789012', telefono: '0995678901', email: 'laura.sanchez@email.com' },
  { nombre: 'Pedro', apellido: 'Díaz Vargas', dni: '0967890123', telefono: '0996789012', email: 'pedro.diaz@email.com' },
  { nombre: 'Sofía', apellido: 'Torres Mendoza', dni: '0978901234', telefono: '0997890123', email: 'sofia.torres@email.com' },
  { nombre: 'Miguel', apellido: 'Ramírez Flores', dni: '0989012345', telefono: '0998901234', email: 'miguel.ramirez@email.com' },
  { nombre: 'Carmen', apellido: 'Herrera Paz', dni: '0990123456', telefono: '0999012345', email: 'carmen.herrera@email.com' },
  { nombre: 'Diego', apellido: 'Vega Córdoba', dni: '0901234567', telefono: '0990123456', email: 'diego.vega@email.com' },
];

const insumos: Partial<Insumo>[] = [
  { nombre: 'Plátano Verde', unidad_medida: 'kg', stock: 500, estado: 'activo' },
  { nombre: 'Plátano Maduro', unidad_medida: 'kg', stock: 300, estado: 'activo' },
  { nombre: 'Aceite Vegetal', unidad_medida: 'litros', stock: 200, estado: 'activo' },
  { nombre: 'Sal Fina', unidad_medida: 'kg', stock: 50, estado: 'activo' },
  { nombre: 'Azúcar', unidad_medida: 'kg', stock: 80, estado: 'activo' },
  { nombre: 'Canela en Polvo', unidad_medida: 'kg', stock: 10, estado: 'activo' },
  { nombre: 'Ajo en Polvo', unidad_medida: 'kg', stock: 15, estado: 'activo' },
  { nombre: 'Chile en Polvo', unidad_medida: 'kg', stock: 12, estado: 'activo' },
  { nombre: 'Limón', unidad_medida: 'unidades', stock: 200, estado: 'activo' },
  { nombre: 'Empaque Biodegradable', unidad_medida: 'unidades', stock: 1000, estado: 'activo' },
];

const productos: Partial<Producto>[] = [
  { nombre: 'Chifles Clásicos Salados', descripcion: 'Chifles de plátano verde crujientes con sal marina', precio: 2.50, categoria: 'Salados', unidad_medida: 'funda 100g', estado: 'activo' },
  { nombre: 'Chifles con Ajo', descripcion: 'Chifles de plátano verde con toque de ajo', precio: 2.75, categoria: 'Salados', unidad_medida: 'funda 100g', estado: 'activo' },
  { nombre: 'Chifles Picantes', descripcion: 'Chifles con chile y limón, sabor intenso', precio: 3.00, categoria: 'Salados', unidad_medida: 'funda 100g', estado: 'activo' },
  { nombre: 'Chifles de Maduro', descripcion: 'Chifles dulces de plátano maduro caramelizado', precio: 3.25, categoria: 'Dulces', unidad_medida: 'funda 100g', estado: 'activo' },
  { nombre: 'Chifles con Canela', descripcion: 'Chifles dulces espolvoreados con canela y azúcar', precio: 3.50, categoria: 'Dulces', unidad_medida: 'funda 100g', estado: 'activo' },
  { nombre: 'Mix Chifles Salados', descripcion: 'Combinación de chifles clásicos, ajo y picantes', precio: 4.50, categoria: 'Mix', unidad_medida: 'funda 200g', estado: 'activo' },
  { nombre: 'Mix Chifles Dulces', descripcion: 'Combinación de chifles de maduro y canela', precio: 5.00, categoria: 'Mix', unidad_medida: 'funda 200g', estado: 'activo' },
  { nombre: 'Chifles Familiar Salados', descripcion: 'Presentación grande de chifles clásicos', precio: 6.00, categoria: 'Familiar', unidad_medida: 'funda 500g', estado: 'activo' },
  { nombre: 'Chifles Familiar Dulces', descripcion: 'Presentación grande de chifles dulces surtidos', precio: 7.00, categoria: 'Familiar', unidad_medida: 'funda 500g', estado: 'activo' },
  { nombre: 'Chifles Premium Gourmet', descripcion: 'Edición especial con mezcla de sabores artesanales', precio: 8.50, categoria: 'Premium', unidad_medida: 'caja 300g', estado: 'activo' },
];

// Recetas: qué insumos necesita cada producto
const productosInsumos: { productoIndex: number; insumoIndex: number; cantidad_necesaria: number }[] = [
  ...
  { productoIndex: 5, insumoIndex: 0, cantidad_necesaria: 0.30 },
  { productoIndex: 5, insumoIndex: 2, cantidad_necesaria: 0.10 },
  ...
  { productoIndex: 6, insumoIndex: 2, cantidad_necesaria: 0.10 },
  ...
  { productoIndex: 7, insumoIndex: 0, cantidad_necesaria: 0.70 },
  ...
  { productoIndex: 8, insumoIndex: 1, cantidad_necesaria: 0.80 },
  ...
  { productoIndex: 9, insumoIndex: 0, cantidad_necesaria: 0.20 },
  { productoIndex: 9, insumoIndex: 1, cantidad_necesaria: 0.20 },
...
async function seed() {
  ...
  const pedidosData = [
    { clienteIndex: 0, fecha: '2026-01-05', estado: 'completado', productos: [{ index: 0, cantidad: 5 }, { index: 3, cantidad: 3 }] },
    { clienteIndex: 1, fecha: '2026-01-06', estado: 'completado', productos: [{ index: 1, cantidad: 10 }, { index: 2, cantidad: 5 }] },
    { clienteIndex: 2, fecha: '2026-01-07', estado: 'pendiente', productos: [{ index: 5, cantidad: 4 }, { index: 6, cantidad: 4 }] },
    { clienteIndex: 3, fecha: '2026-01-08', estado: 'completado', productos: [{ index: 7, cantidad: 2 }, { index: 8, cantidad: 2 }] },
    { clienteIndex: 4, fecha: '2026-01-09', estado: 'en_proceso', productos: [{ index: 9, cantidad: 3 }] },
    { clienteIndex: 5, fecha: '2026-01-10', estado: 'completado', productos: [{ index: 0, cantidad: 20 }, { index: 1, cantidad: 15 }] },
    { clienteIndex: 6, fecha: '2026-01-11', estado: 'pendiente', productos: [{ index: 3, cantidad: 8 }, { index: 4, cantidad: 8 }] },
    { clienteIndex: 7, fecha: '2026-01-12', estado: 'completado', productos: [{ index: 5, cantidad: 6 }] },
    { clienteIndex: 8, fecha: '2026-01-13', estado: 'en_proceso', productos: [{ index: 7, cantidad: 5 }, { index: 9, cantidad: 2 }] },
    { clienteIndex: 9, fecha: '2026-01-13', estado: 'pendiente', productos: [{ index: 0, cantidad: 50 }, { index: 2, cantidad: 30 }] },
  ];
  ...
  const pedidosCompletados = pedidosGuardados.filter((_, i) => pedidosData[i].estado === 'completado');
  ...
  const ordenesData = [
    { productoIndex: 0, cantidad: 100, estado: 'completada', fechaInicio: '2026-01-02', fechaFin: '2026-01-03' },
    { productoIndex: 1, cantidad: 80, estado: 'completada', fechaInicio: '2026-01-03', fechaFin: '2026-01-04' },
    { productoIndex: 2, cantidad: 60, estado: 'completada', fechaInicio: '2026-01-04', fechaFin: '2026-01-05' },
    { productoIndex: 3, cantidad: 50, estado: 'completada', fechaInicio: '2026-01-05', fechaFin: '2026-01-06' },
    { productoIndex: 4, cantidad: 50, estado: 'completada', fechaInicio: '2026-01-06', fechaFin: '2026-01-07' },
    { productoIndex: 5, cantidad: 40, estado: 'en_proceso', fechaInicio: '2026-01-10', fechaFin: '2026-01-12' },
    { productoIndex: 6, cantidad: 40, estado: 'en_proceso', fechaInicio: '2026-01-11', fechaFin: '2026-01-13' },
    { productoIndex: 7, cantidad: 30, estado: 'pendiente', fechaInicio: '2026-01-14', fechaFin: '2026-01-16' },
    { productoIndex: 8, cantidad: 25, estado: 'pendiente', fechaInicio: '2026-01-15', fechaFin: '2026-01-17' },
    { productoIndex: 9, cantidad: 20, estado: 'pendiente', fechaInicio: '2026-01-16', fechaFin: '2026-01-18' },
  ];
  ...
  console.log(`   ✓ ${ordenesGuardadas.length} órdenes de producción creadas\n`);
  ...
  for (let i = 0; i < ordenesGuardadas.length; i++) {
    ...
    const recetaProducto = productosInsumos.filter(pi => pi.productoIndex === productoIndex);
